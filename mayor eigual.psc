Algoritmo mayorque
	// definicion de variable, en este caso mumero 
	definir numero, numerodos como entero ;
	// vamos a preguntar al ususario por un numero 
	...
	//ingresa otro numero if si para ver si los numero son iguales 
	
	si numero = numeodos entonces
